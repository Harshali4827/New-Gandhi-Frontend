...
const ExpenseList = () => {
  ...
  const hasEditPermission = hasPermission('EXPENSE_ACCOUNT', 'UPDATE');
  const hasDeletePermission = hasPermission('EXPENSE_ACCOUNT', 'DELETE');
  const hasCreatePermission = hasPermission('EXPENSE_ACCOUNT', 'CREATE');
